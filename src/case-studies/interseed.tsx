  ...
  return (
    <div style={{ fontSize: 17, lineHeight: 1.75, color: 'rgba(255,255,255,0.8)' }}>
      ...
      <p>
        ...
        startups with mentors, capital, and each other. I joined as a fresh grad frontend developer
        and ended up wearing the UX designer's hat too.
      </p>
      <div style={S.callout}>
        <strong style={{ color: '#fff' }}>TL;DR</strong> — Designed and built a full-stack web app from scratch.
        Soft-launched to hundreds of users. Learnt React from zero in 8 weeks.
      </div>

      <h2 style={S.heading}><span style={S.mono}>## </span>The Problem</h2>
      <p>
        Sustainability startups in SEA were fragmented. Talent and capital existed, but discovery was
        broken — most matches happened over WhatsApp, none of it scaled, and YSI's existing spreadsheet
        workflow was creaking under the load.
      </p>
      ...
      <h2 style={S.heading}><span style={S.mono}>## </span>Research</h2>
      <p>
        Conducted user interviews with 12 founders and 4 mentors. The core insight: founders didn't
        lack ambition — they lacked a single trusted place to find the right people at the right stage.
      </p>
      ...
      <h2 style={S.heading}><span style={S.mono}>## </span>Code Snippet</h2>
...
{`export const StartupCard = ({ s }: Props) => (
  <Card hoverable onClick={() => navigate(\`/s/\${s.slug}\`)}>
    ...
    <Card.Body>
      ...
      <p>
        Interseed taught me that the gap between Figma and shipped code is bigger than any spec doc can
        capture. The work happens in the in-between — the <em>"wait, this isn't right"</em> moments at 2am.
      </p>
      <p>
        It also gave me the confidence to jump into unfamiliar tech stacks. React was completely new to me
        when I started. Eight weeks later, I had shipped 30+ screens. That bias toward learning-by-doing
