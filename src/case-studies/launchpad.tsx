  ...
  return (
    <div style={{ fontSize: 17, lineHeight: 1.75, color: 'rgba(255,255,255,0.8)' }}>
      ...
      <p>
        ...
        residents. In 2020, COVID-19 forced the entire event online — and we had six weeks to build
        a website that could replace a physical campus experience.
      </p>
      <div style={S.callout}>
        <strong style={{ color: '#fff' }}>TL;DR</strong> — Designed and built a multi-page website with virtual
        tours, dynamic content, and a multiplayer interactive canvas for 300 residents.
      </div>

      <h2 style={S.heading}><span style={S.mono}>## </span>The Problem</h2>
      <p>
        New students couldn't visit campus. They had no way to explore the college, meet committee members,
        or understand what life at Tembusu would look like. The orientation programme needed to live entirely
        on a website.
      </p>
