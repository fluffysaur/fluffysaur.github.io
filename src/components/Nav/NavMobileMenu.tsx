...
export function NavMobileMenu({
    ...
    return (
        <div ref={menuRef} className="relative flex items-center px-2 md:hidden">
            <Button
                onClick={onToggle}
                variant="icon"
                size="sm"
            ...
            {isOpen && (
                <div className="absolute right-0 top-full z-50 w-screen border-b border-(--outline-variant) bg-(--surface-container) shadow-2xl">
                    <div className="py-1">
                        {tabs.map((tab) => {
